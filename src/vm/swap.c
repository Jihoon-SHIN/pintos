...
// 	swap_bitmap = bitmap_create(disk_size(swap_block));
...
//   { 
//       disk_write(swap_block, free_index * SECTORS_PER_PAGE + i,
// 		  (uint8_t *) frame + i * DISK_SECTOR_SIZE);
//   }
...
//   for (i = 0; i < SECTORS_PER_PAGE; i++)
//   {
//       disk_read(swap_block, used_index * SECTORS_PER_PAGE + i, (uint8_t *) frame + i * DISK_SECTOR_SIZE);
//   }
//   lock_release(&swap_lock);
// }